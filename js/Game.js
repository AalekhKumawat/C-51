class Game {
         ...
         displayRanks(){
          ...
          player.getPlayerInfo()
           ...
           image(s_image , displayWidth/4 , -100+displayHeigh/9 , 225 , 220 )
          textAlign(CENTER)
          textSize(50)
          for(var plr in allPlayers){
            if(allPlayers[plr].place===1){
            text("First:"+allPlyers[plr].name,0,85)
          }
            ...
            textSize(30)
            text("Honourable mansion:"+allPlayers[plr].name , 0 , 225)
          }
        }
         }}